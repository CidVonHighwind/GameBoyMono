    ...
    class ScreenRenderer
    {
        ...
        public void RenderScreen(SpriteBatch spriteBatch)
        {
            ...
            for (int i = startAddress; i <= endAddress; i++)
            {
                ...
                spriteBatch.Draw(LCDC_Bit4 ? sprTileData0 : sprTileData1, new Rectangle(posX, posY, 8, 8),
            ...
            {
                // Byte0-2:
                int posY = (Game1.gbCPU.generalMemory[i] - 16);
                int posX = (Game1.gbCPU.generalMemory[i + 1] - 8);
                ...
                // draw the tile
                spriteBatch.Draw(sprTileData0, new Rectangle(posX, posY, 8, 8), new Rectangle((tileNumber % 16) * 8, (tileNumber / 16) * 8, 8, 8),
                    Color.White, 0, Vector2.Zero, sprEffect, 0);

                // draw the second part of the sprite if in 8x16 mode
                if (LCDC_Bit2)
                    spriteBatch.Draw(sprTileData0, new Rectangle(posX - 8, posY - 16 + 8, 8, 8),
